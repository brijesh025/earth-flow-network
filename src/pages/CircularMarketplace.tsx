...
const CircularMarketplace = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      description:
        "Portable solar chargers with recycled electronic components",
      price: 899,
      originalPrice: 1299,
      image:
        "./solar.png",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Discover unique products made by NGOs from recycled materials.
              Support circular economy while empowering communities and reducing
            ...
            <TabsContent value="impact" className="space-y-8">
              <div className="text-center max-w-3xl mx-auto mb-12">
                ...
                <p className="text-lg text-muted-foreground">
                  See how our circular marketplace is creating positive
              ...
              <Card className="shadow-medium border-0">
                <CardHeader>
                  ...
                  <CardDescription>
                    Verified impact tokens and carbon credits generated through
